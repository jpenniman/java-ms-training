...
public class AppConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    @Bean
    public AccountsServiceClientConfig accountsServiceClientConfig(){
        AccountsServiceClientConfig config = new AccountsServiceClientConfig();
        config.setUrl(properties.getProperty("account-service.url"));
        return config;
    }
